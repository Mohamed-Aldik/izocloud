...
export const CategoriesListResults = ({ customers, ...rest }: any, props: any) => {
                ...
                <>
                  ...
                  >
                    ...
                    <TableCell>
                      <IconButton
                        aria-label="expand"
                        size="small"
                        onClick={() => setOpenChild(openChild == index ? -1 : index)}
                      >
                        {openChild == index ? <KeyboardArrowUpIcon /> : <KeyboardArrowDownIcon />}
                      </IconButton>
                    </TableCell>
                    <TableCell>
                      {/* @ts-ignore */}
                  ...
                  <TableRow>
                    <TableCell style={{ paddingBottom: 0, paddingTop: 0 }} colSpan={6}>
                      <Collapse in={openChild == index && true} timeout="auto" unmountOnExit>
                        <Box sx={{ margin: 1 }}>
                          ...
                          <Table size="small" aria-label="purchases">
                            ...
                            <TableBody>
                              <TableRow>
                                ...
                                <TableCell align="right">dsds</TableCell>
                                <TableCell align="right">dsds</TableCell>
                                <TableCell align="right">dsds</TableCell>
